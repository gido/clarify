...
<head>
    <title><?php echo $screen['title'] ?> - Clarify</title>
    <?php require 'partials/head.php'; ?>
</head>
<body>
    <div class="mod modScreen" 
         data-screen="<?php echo $screen['id'] ?>" 
         data-layer="1" 
         data-width="<?php echo $screen['width'] ?>"
         data-height="<?php echo $screen['height'] ?>"
         data-image="<?php echo $screen['image'] ?>">
